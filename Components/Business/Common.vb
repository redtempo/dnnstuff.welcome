Namespace DNNStuff.Welcome
    Public Class Common
        ...
        Public Const ProductName As String = "Welcome"
        ...
        Public Shared Function TrialWarning() As String
            ...
            sb.AppendFormat("<hr /><p>Thank you for evaluating <a style=""text-decoration:underline"" target=""_blank"" ")
